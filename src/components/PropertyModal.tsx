              ...
              <div className="mb-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <span className="px-4 py-2 bg-emerald-50 text-[#50C878] rounded-full font-semibold text-sm">
                        ...
                        <>
                          ...
                          <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 z-[70]">
                            ...
                            <button
                              ...
                              className="w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors flex items-center gap-3"
                            >
                              <div className="w-10 h-10 bg-gradient-to-br from-emerald-600 via-emerald-700 to-orange-500 rounded-full flex items-center justify-center">
                                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 rounded-2xl p-6 mb-6">
